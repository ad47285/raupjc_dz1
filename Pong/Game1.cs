    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            PaddleTop = new Paddle(GameConstants.PaddleDefaultWidth,
                GameConstants.PaddleDefaulHeight, GameConstants.PaddleDefaulSpeed);
            PaddleTop.X = (screenBounds.Width - PaddleBottom.Width) / 2;
            PaddleTop.Y = 0;
            ...
            {
                X = (screenBounds.Width - GameConstants.DefaultBallSize) / 2,
                Y = (screenBounds.Height - GameConstants.DefaultBallSize) / 2
            };
